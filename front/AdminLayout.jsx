...
const AdminLayout = ({usern, getUsern}) => {
...
>
  ...
  items={[
    ...
    },
    {
      key: '3',
      icon:  <HeartOutlined />,
      label: 'Announce Creator',
      onClick: () =>history(`announcecreator`),
    },
    {
      key: '4',
      ...
      children:[{
        ...
        onClick:  () =>history('learningpaths')},
        {
          ...
          label: 'Learning Paths Creator',
          onClick:  () =>history('lpcreator')},
