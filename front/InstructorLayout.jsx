...
const InsctructorLayout = ({usern, getUsern}) => {
...
>
  ...
  items={[
    ...
    },
    {
      ...
      label: 'Learning Paths Manager',
      children:[{
        key: '3.1',
       
        label: 'Learning Paths Editor',
    ...
    },
    {
      ...
      label: 'Practise Manager',
      children:[{
        key: '3.1',
       
        label: 'Create a Problem',
        onClick: () => history('problemcreator')},
        
        {
          key: '3.2',
         
          label: 'Problem List',
        onClick:  () =>history('problemlist')},
    ...
    },
    {
      ...
      children:[{
        ...
        label: 'Create a Competiton',
        onClick:  () =>history('competitioncreator')},
...
export default InsctructorLayout;