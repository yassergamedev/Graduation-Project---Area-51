...
function CodeEditorCompetiton({boilerplate , sendCode , sendSubmission, output, result, console,subBool}) {
  ...
  return (
    ...
    <button style={{ textAlign: 'left', marginLeft : '14px' }} onClick={()=>Modal.warning({
      content : "Already Submitted Problem"
    })}>Submit</button> }
    </>
  );
}

export default  CodeEditorCompetiton;
